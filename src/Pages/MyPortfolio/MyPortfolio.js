    ...
    return (
        <div className='flex items-center justify-center mt-5'>
            <div class="bg-base-200 py-5">
                <h2 className="text-3xl text-primary text-center font-bold">MD ABIR</h2>

                <div className='px-10 mt-5'>
                    <p className="text-"><span className='font-bold'>Email:</span> abir03512@gmail.com</p>
                    ...
                    <p className="text-"><span className='font-bold'>Links of my latest three projects:</span>
                        <ul>
                            <li><a href="https://assignment-10-51d3e.firebaseapp.com/"><span className='text-primary'>1. Visapress</span></a></li>
                            <li><a href="https://module-patties-60-1.web.app/"><span className='text-primary'>2. Smartphone Warehouse</span></a></li>
