        ...
        <div>
            ...
            <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                    ...
                    <h3 class="font-bold text-lg text-secondary text-center">Order for: {name}</h3>
                    <form onSubmit={hadelBooking} className='grid grid-cols-1 gap-3 justify-items-center mt-2'>
                    <input
              type="text"
              name="name"
            ...
            />
                        ...
                        <input type="text" placeholder="Price" name='price' class="input input-bordered w-full max-w-xs" />
